...
## Backlog
- **Review queue:** nine archived tasks, three active Wave 4 acceptance tasks, eight deferred backlog items and two Inbox observations are tracked in [Tasks](TASKS.md). Overall progress: 9/20 (45%).
...
- Tasks: nine archived, three active acceptance tasks, eight deferred backlog items and two Inbox observations; 9/20 (45%). GitHub #2/#6 remain deferred; #5 shipped in 1.6.2.
